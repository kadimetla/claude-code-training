...
name: osquery
description: |
  System diagnostics via osquery. Use when the user asks about CPU usage,
  memory consumption, running processes, network connections, system health,
  or anything resembling "why is my computer slow", "what's hammering my CPU",
  "what's using memory", "fan is running hot", "what processes are running",
